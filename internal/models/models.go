...
type Group struct {
	...
	Banner      string `gorm:"size:1024" json:"banner" form:"banner"`                                                                     // 封面/横幅图片URL
	Notice      string `gorm:"type:text" json:"notice" form:"notice"`                                                                  // 群组公告
	Rules       string `gorm:"type:text" json:"rules" form:"rules"`                                                                    // 群组规则
