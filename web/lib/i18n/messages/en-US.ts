const enUS = {
    ...
    settingsForm: {
      ...
      upload: {
        ...
        placeholder: {
          ...
          r2AccountId: "Enter Cloudflare Account ID",
          r2Bucket: "Enter R2 Bucket name",
          r2PublicHost: "Enter public host (optional), e.g. https://cdn.example.com",
          r2AccessKeyId: "Enter R2 AccessKey ID",
          r2AccessKeySecret: "Enter R2 AccessKey Secret",
  ...
  user: {
    groups: {
      ...
      userCreatedGroups: "Community Groups",
      myGroups: "My Groups",
      viewAll: "View All",
      noPinnedTopics: "No pinned topics",
      enter: "Enter",
      ...
      slugHint: "URL-friendly name, letters and numbers only",
      nameRequired: "Group name is required",
      noHotTopics: "No hot topics yet",
      nameLabel: "Group Name",
      namePlaceholder: "Enter group name",
      slugLabel: "Slug",
      slugPlaceholder: "my-group",
      slugHelp: "URL-friendly name, auto-generated from group name. Letters, numbers, and hyphens only.",
      ...
      noticePlaceholder: "Enter group announcement",
      rulesLabel: "Rules",
      ...
      alreadyCheckedIn: "Already checked in today",
      checkInNotMember: "Join the group first to check in",
      createPostNotMember: "Join the group first to post",
